...
class ContactModelTest(TestCase):
    def test_create_contact_with_valid_data(self):
        ...
        self.assertEqual(contact.mail, "john.doe@example.com")
    ...
    def test_email_uniqueness(self):
        Contact.objects.create(name="John Doe", mail="john.doe@example.com")
        with self.assertRaises(Exception):
            Contact.objects.create(name="Jane Doe", mail="john.doe@example.com")
